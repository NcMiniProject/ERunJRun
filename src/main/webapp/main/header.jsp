...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
		...
		<c:if test="${sessionScope.memberDTO.id != null}">
			...
			<a href="#" data-bs-toggle="modal" data-bs-target="#myPageModal">
				<svg width="50px" height="50px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
	    ...
	    <div class="navbar_burger">
	        <svg xmlns="http://www.w3.org/2000/svg" width="48px" height="48px" fill="currentColor" class="bi bi-list" viewBox="0 0 16 16">
		...
		<div class="navbar_menu">
		  <a href="#">홈으로</a>
		  <a href="#">공지</a>
		  <a href="./board/boardMain.do">게시판</a> <!--오혜진수정 -->
		  <a href="#">오운완</a>
